...
export const STORAGE_KEYS = Object.freeze({
  ...
  fileTransferOutbox: 'ekklesiaPulse.fileTransferOutbox',
  fileTransferState: 'ekklesiaPulse.fileTransferState',
...
export const ACCOUNT_OWNED_STORAGE_KEYS = Object.freeze([
  ...
  STORAGE_KEYS.fileTransferOutbox,
  STORAGE_KEYS.fileTransferState,
...
export const INDEXED_DB_STORAGE_AREAS = Object.freeze([
  ...
  Object.freeze({
    database: 'ekklesia-pulse',
    store: 'messagingAttachments',
    purpose: 'Local-first message attachment binaries',
  }),
  Object.freeze({
    database: 'ekklesia-pulse',
    store: 'syncOutbox',
